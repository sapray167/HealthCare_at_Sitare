...
from db import (
    init_db, insert_record, update_record_draft, get_record, update_record_file_path, list_records,
...
async def extract(file: UploadFile = File(...), form_type: str = Form(...), user_email: str = Form("dr.smith@health.ai")):
    ...
    update_record_file_path(record_id, storage_path)
...
def send_missing_email(req: SendEmailRequest):
    ...
    form_link = f"http://localhost:8000/frontend/fill_missing.html?record_id={req.record_id}"
